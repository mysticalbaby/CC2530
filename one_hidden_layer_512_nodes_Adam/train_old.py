...
def train(CC2530):
    ...
    cost207_phased_test_feed = {x: CC2530.cost207_phased_test.images, y_: CC2530.cost207_phased_test.labels}
...
#                saver.save(sess, os.path.join(MODEL_SAVE_PATH, MODEL_NAME), global_step=global_step)
                ...
                cost207_phased_test_accuracy_score = sess.run(accuracy, feed_dict=cost207_phased_test_feed)
                print("After %d training step(s), cost207_phased_test accuracy = %g" % (step, cost207_phased_test_accuracy_score))
